...
const About = () => {
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="flex flex-col flex-grow px-5 items-center mt-2">
                <div className="flex gap-8">
                    <img className="w-4/12 border-8 border-orange-500 rounded-[50%] hidden sm:block" src={resimage} alt="food image" />
                    <div className="flex flex-col gap-5 justify-center">
                        <h1 className="text-6xl font-Dancing font-bold text-orange-500">Anytime, Anywhere..</h1>
                        <h1 className=" font-Montserrat">Welcome to Cravings, where our journey began with a passion for revolutionizing the way people experience food. Established in 2002,
                            we set out with a clear mission: to bring convenience, quality, and satisfaction to every doorstep. Our commitment to excellence is
                            ...
                            Beyond business, we are dedicated to social responsibility, actively supporting local communities and promoting sustainable practices.
                            ...
                            We invite you to join us on this culinary adventure and discover why we're more than just a food delivery app, we're a partner in creating memorable dining experiences and we're always here to serve you.</h1>
                    </div>
                </div>
            </div>
